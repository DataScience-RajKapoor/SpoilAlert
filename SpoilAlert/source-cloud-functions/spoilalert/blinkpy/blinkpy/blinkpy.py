...
class Blink:
    ...
    def save(self, file_name):
        ...
        ## Modifying download function to 
    def download_videos(self, since=None, camera="all", stop=10, debug=False):
        """
        ...
        for page in range(1, stop):
            ...
            self._parse_downloaded_items(result, camera, debug)
